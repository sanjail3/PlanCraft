...
class PlanAgent:
    ...
    def prepare_agent(self):
        ...
        * If using st.ttest_ind make sure to take care of the null values
        * Do not try to plot via pandas eg, df.hist(), df.plot(), etc
        <<<

        Matching Values Tool Instructions:
        >>>
        * Returns the most similar values in column based on the input string
        * If a filter ona dataframe returns zero results, then use this tool to find the right filter for the string column
        ...
        * Always try to create a relevant plot at the end of analysis
        * Try to create simple plots over complex plots
        * Prefer bar plots
        <<<
        ...
        * Provide local image path of the house image generated by the house plan generator tool
        ...
        self.tools = [get_house_plan_tool(),image_to_3d_creator_tool(),get_budget_calculation_tool(),get_plot_gen_lc_tool(),get_python_lc_tool()] 
